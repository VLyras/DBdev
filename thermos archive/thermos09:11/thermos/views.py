...
from __init__ import app, db, login_manager, mail, Message
from forms import TripForm, LoginForm, SignupForm, ContactForm
...
def contact():
    ...
    if request.method == 'POST':
        msg = Message(form.subject.data, sender='driftbee.info@gmail.com', recipients=['driftbee.info@gmail.com'])
        msg.body = """
             From: %s <%s>
             %s
